...

{
    ...
    public function basesave(){
        ...
        $homeslice['slice1'] = input("homeslideuploadpic1");
        if(!$homeslice['slice1']){

            $homeslice['slice1'] = input("homeslide1") ;

        }

        $homeslice['slice2'] = input("homeslideuploadpic2");
        if(!$homeslice['slice2']){

            $homeslice['slice2'] = input("homeslide2") ;

        }

        $homeslice['slice3'] = input("homeslideuploadpic3");
        if(!$homeslice['slice3']){

            $homeslice['slice3'] = input("homeslide3") ;

        }

        $homeslice['slice4'] = input("homeslideuploadpic4");
        if(!$homeslice['slice4']){

            $homeslice['slice4'] = input("homeslide4") ;

        }

        $data['homeslide'] = serialize($homeslice);
