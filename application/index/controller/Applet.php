...
//            Db::name('wd_xcx_applet') ->where('id', $res) ->update(['p_id'=>$p_id]);
            ...
            $tabbar2 = [
                    'tabbar_name' => '商品分类',
                    'tabbar_url' => '/PagesA/catelist/catelist?type=showProMore',
                    'tabbar_linktype' => 'page',
                    'tabbar' => 2,
            ...
            $usercenter_data = array(
                'title1' => '分销中心',
                'num1' => 1,
                'thumb1' => $_SERVER['HTTP_HOST'].'/image/nifx.png',
                'flag1' => 2,
                'url1' => '/pagesFenxiao/fenxiao_center/fenxiao_centear',
                'icon1' => 'icon-x-fenxiao2',
                'title2' => '签到中心',
                'num2' => 2,
                'thumb2' => $_SERVER['HTTP_HOST'].'/image/niqd.png',
                'flag2' => 1,
                'url2' => '/pagesSign/index/index',
                'icon2' => 'icon-x-qiandao2',
                'title3' => '积分兑换中心',
                'num3' => 3,
                'thumb3' => $_SERVER['HTTP_HOST'].'/image/nijf.png',
                'flag3' => 1,
                'url3' => '/pagesExchange/list/list',
                'icon3' => 'icon-x-jifen',
                'title4' => '我的餐饮订单',
                'num4' => 4,
                'thumb4' => $_SERVER['HTTP_HOST'].'/image/nicy.png',
                'flag4' => 1,
                'url4' => '/pagesFood/food_my/food_my',
                'icon4' => 'icon-x-diancan',
                'title5' => '我的订单',
                'num5' => 5,
                'thumb5' => $_SERVER['HTTP_HOST'].'/image/nidd.png',
                'flag5' => 1,
                'url5' => '/pages/order_more_list/order_more_list',
                'icon5' => 'icon-x-gouwu',
                'title6' => '我的付费视频',
                'num6' => 6,
                'thumb6' => $_SERVER['HTTP_HOST'].'/image/nisp.png',
                'flag6' => 1,
                'url6' => '/pages/order_art/order_art',
                'icon6' => 'icon-x-shipin',
                'title7' => '我的优惠券',
                'num7' => 7,
                'thumb7' => $_SERVER['HTTP_HOST'].'/image/niyh.png',
                'flag7' => 2,
                'url7' => '/pages/mycoupon/mycoupon',
                'icon7' => 'icon-x-youhuiquan2',
                'title8' => '我的收藏',
                'num8' => 8,
                'thumb8' => $_SERVER['HTTP_HOST'].'/image/nisc.png',
                'flag8' => 2,
                'url8' => '/pages/collect/collect',
                'icon8' => 'icon-c-xing1',
                'title9' => '我的地址',
                'num9' => 9,
                'thumb9' => $_SERVER['HTTP_HOST'].'/image/nidz.png',
                'flag9' => 2,
                ...
                'title11' => '拼团订单',
                'num11' => 11,
                'thumb11' => $_SERVER['HTTP_HOST'].'/image/ptdd.png',
                'flag11' => 1,
                'url11' => '/pagesPt/orderlist/orderlist',
                'icon11' => 'icon-x-pintuan',
                'title12' => '预约订单',
                'num12' => 12,
                'thumb12' => $_SERVER['HTTP_HOST'].'/image/yydd.png',
                'flag12' => 1,
                'url12' => '/pagesReserve/orderList/orderList',
                'icon12' => 'icon-x-qiandao3',
                'title13' => '秒杀订单',
                'num13' => 13,
                'thumb13' => $_SERVER['HTTP_HOST'].'/image/ptdd.png',
                'flag13' => 1,
                'url13' => '/pagesFlashSale/orderlist_dan/orderlist_dan',
                'icon13' => 'icon-x-miaosha',
                'title14' => '店铺管理',
                'num14' => 14,
                'thumb14' => $_SERVER['HTTP_HOST'].'/image/ptdd.png',
                'flag14' => 1,
                'url14' => '/pagesPluginShop/manage_index/manage_index',
                'icon14' => 'icon-c-dianpu2',
                'title15' => '我的表单',
                'num15' => 15,
                'thumb15' => $_SERVER['HTTP_HOST'].'/image/ptdd.png',
                'flag15' => 1,
                'url15' => '/PagesA/form_list/form_list',
                'icon15' => 'icon-x-dingdan2',
                'title16' => '砍价订单',
                'num16' => 16,
                'thumb16' => $_SERVER['HTTP_HOST'].'/image/ptdd.png',
                'flag16' => 1,
                'url16' => '/pagesBargain/orderlist/orderlist',
                'icon16' => 'icon-x-kanjia',
                'title17' => '客服',
                'num17' => 17,
                'thumb17' => $_SERVER['HTTP_HOST'].'/image/ptdd.png',
                'flag17' => 1,
                'url17' => '',
                'icon17' => 'icon-x-kefu',
                'title18' => '活动报名',
                'num18' => 18,
                'thumb18' => $_SERVER['HTTP_HOST'].'/image/ptdd.png',
                'flag18' => 1,
                'url18' => '/pagesActive/apply_collect/apply_collect',
                'icon18' => 'icon-x-pingjia',
                'title19' => '我的评价',
                'num19' => 19,
                'thumb19' => $_SERVER['HTTP_HOST'].'/image/ptdd.png',
                'flag19' => 1,
                'url19' => '/pagesOther/evaluate/evaluate?user=1',
                'icon19' => 'icon-x-pingjia2',
                'title20' => '联系我们',
                'num20' => 20,
                'thumb20' => $_SERVER['HTTP_HOST'].'/image/ptdd.png',
                'flag20' => 1,
                'url20' => '',
                'icon20' => 'icon-c-shouji',
                'title21' => '扫码核销',
                'num21' => 21,
                'thumb21' => $_SERVER['HTTP_HOST'].'/image/ptdd.png',
                'flag21' => 1,
                'url21' => '',
                'icon21' => 'icon-x-saoma',
                'title22' => '多商户订单',
                'num22' => 22,
                'thumb22' => $_SERVER['HTTP_HOST'].'/image/ptdd.png',
                'flag22' => 1,
                'url22' => '/pages/order_more_list/order_more_list',
                'icon22' => 'icon-x-ruzhu',
                'title23' => '手机管理',
                'num23' => 23,
                'thumb23' => $_SERVER['HTTP_HOST'].'/image/mobile.png',
                'flag23' => 1,
                'url23' => '/pages/mobilePages/index',
                'icon23' => 'icon-x-mobile'
            );
            ...
            $res =  Db::name('wd_xcx_usercenter_set')->insert($usercenter_data);
        }
    ...
    //保存用户修改的个人信息
    public function save_admininfo()
    {
    ...
    public function del_applet()
    {
        ...
        for ($i = 0; $i < count($delfile); $i++) {
            if (is_file($delfile)[$i]) {
                unlink($delfile)[$i];
            }
        };
        $delres = Db::table('wd_xcx_applet')->where('id', $id)->delete();
