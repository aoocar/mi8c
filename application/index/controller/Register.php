...
class Register extends Controller
{
            ...
            if ($userid) {//创建小程序
                ...
                if ($res) {   //设置推广位ID
                    ...
                    $usercenter_data = array(
                        ...
                        'flag19' => 1,
                        'url19' => '/pages/evaluate_list/evaluate_list?user=1',
                        ...
                        'icon22' => 'icon-x-ruzhu',
                        'num23' => 23,
                        'thumb23' => 'http://four.nttrip.cn/image/mobile.png',
                        'flag23' => 1,
                        'url23' => '/index/login/index',
    ...
    public function send_sms($to, $code = "", $accessKeyId, $accessKeySecret, $signName, $templateCode)
    {
    ...
    public function check()
    {
        ...
        if ($is1) {
            ...
            $err_code = 3;
        } elseif (intval($code) != intval($send_code)) {
            $err_code = 4;
        }
        return $err_code;
    }
