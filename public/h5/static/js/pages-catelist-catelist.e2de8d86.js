(window["webpackJsonp"] = window["webpackJsonp"] || []).push([
    ["pages-catelist-catelist"], {
                    ...
                    methods: {
                        ...
                        toprodetail: function(i) {
                            var t = i.currentTarget.dataset.id,
                                e = "/pages/showProMore/showProMore?id=" + t;
                        ...
                        swiperChange: function(i) { this.swiperCurrent = i.target.current, console.log(i) },
                        ...
                        search: function() {
                            ...
                            i ? uni.navigateTo({ url: "/PagesA/checkPro/checkPro?title=" + i + "&type=" + this.type }) : uni.showModal({ title: "提示", content: "请输入搜索内容！", showCancel: !1 })
                        }
                    }
                };
            t.default = r
        },
        "165b": function(i, t, e) { t = i.exports = e("2350")(!1), t.push([i.i, "uni-page-body[data-v-24bb48b5]{background:#f2f2f2}.goods[data-v-24bb48b5]{width:100%;background:#fff}.goods_choose[data-v-24bb48b5]{display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex}.menu-wrapper[data-v-24bb48b5]{-webkit-box-flex:0;-webkit-flex:0 0 80px;-ms-flex:0 0 80px;flex:0 0 80px;width:20%;background:#f6f6f6}.menu-item[data-v-24bb48b5]{display:block;height:%?110?%;width:100%;-webkit-box-sizing:border-box;box-sizing:border-box;padding:0 %?12?%;line-height:%?110?%;color:#666;font-size:%?24?%;text-align:center;white-space:nowrap;overflow:hidden;-o-text-overflow:ellipsis;text-overflow:ellipsis;border-bottom:%?4?% solid #fff}.menu-item.current[data-v-24bb48b5]{color:#333;background:#fff;font-size:%?26?%\n\t/* border-left: 8rpx solid #ffd946; */}.menu-item .current_box[data-v-24bb48b5]{display:inline-block;width:%?6?%;height:%?20?%;margin-right:%?10?%;border-radius:%?10?%}.foods-wrapper[data-v-24bb48b5]{width:80%;min-width:0}.slld1[data-v-24bb48b5]{overflow:hidden;font-weight:700;-o-text-overflow:ellipsis;text-overflow:ellipsis;white-space:nowrap;margin-bottom:%?6?%}.slld2[data-v-24bb48b5]{overflow-y:hidden;-o-text-overflow:ellipsis;text-overflow:ellipsis;font-size:%?24?%;min-height:%?36?%;max-height:%?72?%;display:block;line-height:%?36?%;margin-bottom:%?6?%}.xnerkd[data-v-24bb48b5]{padding:%?20?%;font-size:%?24?%;border-bottom:%?2?% solid #eee;font-weight:700}.renmb[data-v-24bb48b5]{font-size:%?26?%}.price2[data-v-24bb48b5]{float:left;color:#ff4965}.price3[data-v-24bb48b5]{float:left;color:#999;margin-left:10px;text-decoration:line-through}.cateslide2[data-v-24bb48b5]{padding:0 %?20?% 0}\n\n.swi_img[data-v-24bb48b5]{width:100%;height:%?160?%;margin-top:%?34?%;border-radius:%?10?%}.active_img[data-v-24bb48b5]{height:%?220?%;margin-top:0}.food-grouping[data-v-24bb48b5]{width:33.3%;padding:%?20?%;-webkit-box-sizing:border-box;box-sizing:border-box;text-align:center;display:inline-block}.food-grouping>uni-image[data-v-24bb48b5]{width:%?100?%;height:%?100?%;display:block;margin:auto;border-radius:%?10?%}.food-grouping2[data-v-24bb48b5]{width:auto;display:inline-block;margin-right:%?20?%;padding:%?2?% %?10?%;font-size:%?24?%;-webkit-box-sizing:border-box;box-sizing:border-box;border:%?2?% solid #ececec;border-radius:%?8?%;color:#666}.active_fg2[data-v-24bb48b5]{background:-webkit-gradient(linear,left top,right top,from(#e98371),to(#ec5c3e));background:-o-linear-gradient(left,#e98371,#ec5c3e);background:linear-gradient(90deg,#e98371,#ec5c3e);border:none;color:#fff}\n\n.food-grouping>uni-view[data-v-24bb48b5]{font-size:%?22?%;overflow:hidden;-o-text-overflow:ellipsis;text-overflow:ellipsis;white-space:nowrap;margin-top:%?10?%}.input-style[data-v-24bb48b5]{border:0;height:%?70?%;line-height:%?70?%;-webkit-box-sizing:border-box;box-sizing:border-box;font-size:%?26?%;background:#f6f6f6;padding-left:%?60?%}.searchBox[data-v-24bb48b5]{display:block;padding:%?20?%;-webkit-box-sizing:border-box;box-sizing:border-box;background:#fff}.list_search[data-v-24bb48b5]{position:relative;width:100%;height:%?70?%;line-height:%?70?%;background-color:#f6f6f6;overflow:hidden;border-radius:%?10?%;border:%?2?% solid #f9f9f9;padding:0 %?20?%;-webkit-box-sizing:border-box;box-sizing:border-box}.ssk-icon[data-v-24bb48b5]{position:absolute;top:0;left:%?24?%;color:#ccc}.nr_pageNoticeT[data-v-24bb48b5]{text-align:center;margin-top:55px}.nav_title[data-v-24bb48b5]{height:%?50?%;width:auto;margin:%?30?% 0 0 %?20?%;white-space:nowrap}.nav_titlenum[data-v-24bb48b5]{font-size:%?24?%;color:#999;line-height:%?60?%;margin-left:%?20?%}.pro_boxshodow[data-v-24bb48b5]{-webkit-box-sizing:border-box;box-sizing:border-box;width:94%;height:%?200?%;border-radius:%?20?%;-webkit-box-shadow:0 0 40px 0 rgba(70,69,68,.07);box-shadow:0 0 40px 0 rgba(70,69,68,.07);margin:0 0 %?20?% %?20?%;padding:%?16?%;display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex}.pro_bsimg[data-v-24bb48b5]{width:33%;overflow:hidden}.pro_bsimg uni-image[data-v-24bb48b5]{width:100%;height:100%;border-radius:%?10?%}.pro_bscont[data-v-24bb48b5]{-webkit-box-sizing:border-box;box-sizing:border-box;width:67%;padding-left:%?10?%;display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-box-orient:vertical;-webkit-box-direction:normal;-webkit-flex-flow:column;-ms-flex-flow:column;flex-flow:column}.pro_cont_title[data-v-24bb48b5]{font-size:%?28?%;color:#333;width:100%;overflow:hidden;white-space:nowrap;-o-text-overflow:ellipsis;text-overflow:ellipsis;display:inline-block;height:24%}.pro_cont_desc[data-v-24bb48b5]{font-size:%?24?%;color:#999;width:100%;overflow:hidden;white-space:nowrap;-o-text-overflow:ellipsis;text-overflow:ellipsis;display:inline-block;height:27%}.pro_cont_price[data-v-24bb48b5]{height:42%;display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex}.pro_price[data-v-24bb48b5]{width:85%;display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-box-orient:vertical;-webkit-box-direction:normal;-webkit-flex-flow:column;-ms-flex-flow:column;flex-flow:column}.pro_price_vip[data-v-24bb48b5]{font-size:%?20?%;padding:%?2?% %?6?%;-webkit-box-sizing:border-box;box-sizing:border-box;display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;position:relative}.pro_price_vip uni-image[data-v-24bb48b5]{width:%?12?%;height:auto}.pro_price_itemvip0[data-v-24bb48b5]{border-radius:%?8?% 0 0 %?8?%;color:#fce0bc;padding:%?2?% %?4?% 0 %?2?%;background:#454545}.pro_price_itemvip1[data-v-24bb48b5]{border-radius:0 %?8?% %?8?% 0;color:#454545;background-color:#fce0bc;padding:%?4?% %?8?% 0 0}.pro_price_admin[data-v-24bb48b5]{color:#ec5c3e}.pro_price_admin[data-v-24bb48b5]{height:50%}.pro_price_admin uni-text[data-v-24bb48b5]{font-size:%?20?%;color:#ccc;text-decoration:line-through;margin-left:%?20?%}.pro_gwc[data-v-24bb48b5]{width:15%;margin:%?16?%;-webkit-box-sizing:border-box;box-sizing:border-box}.pro_gwc uni-image[data-v-24bb48b5]{width:%?50?%}.nav_x_one[data-v-24bb48b5]{white-space:nowrap;display:inline-block;padding:%?10?%}.nav_xt[data-v-24bb48b5]{display:inline-block;margin:0 %?20?%}.nav_pros[data-v-24bb48b5]{height:90%;-webkit-box-sizing:border-box;box-sizing:border-box}.nav_pro_item[data-v-24bb48b5]{width:46%;-webkit-box-shadow:0 0 40px 0 rgba(70,69,68,.07);box-shadow:0 0 40px 0 rgba(70,69,68,.07);height:%?570?%;border-radius:%?20?%;display:inline-block;-webkit-box-sizing:border-box;box-sizing:border-box;background:#fff;overflow:hidden;margin:0 %?20?% %?20?%}.nav_pro_item[data-v-24bb48b5]:first-child{margin-top:%?20?%}.nav_pro_item[data-v-24bb48b5]:nth-child(2n){margin:0 0 %?20?%}.nav_pro_img[data-v-24bb48b5]{height:60%}.nav_pro_img uni-image[data-v-24bb48b5]{height:100%;width:100%}.nav_pros_cont[data-v-24bb48b5]{height:40%;display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-box-orient:vertical;-webkit-box-direction:normal;-webkit-flex-flow:column;-ms-flex-flow:column;flex-flow:column;-webkit-box-sizing:border-box;box-sizing:border-box;padding:%?20?% 0 %?20?% %?20?%}\n\n/* 规格 弹框 */.guige[data-v-24bb48b5]{width:100%;position:fixed;bottom:0;left:0;background:rgba(0,0,0,.7);z-index:999}.guige .guige_con[data-v-24bb48b5]{position:absolute;left:0;bottom:0;width:100%;background:#fff;border-top-left-radius:%?20?%;border-top-right-radius:%?20?%}.flex-row[data-v-24bb48b5]{display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-box-orient:horizontal;-webkit-box-direction:normal;-webkit-flex-direction:row;-ms-flex-direction:row;flex-direction:row}.guigeTopC[data-v-24bb48b5]{width:%?690?%;padding-bottom:%?20?%;position:relative}.guigeTopCImg[data-v-24bb48b5]{width:%?180?%;height:%?180?%;border-radius:%?10?%;display:inline-block;overflow:hidden}.guigeTopCT[data-v-24bb48b5]{width:%?432?%;display:inline-block;margin-left:%?30?%}.guigeTop .price[data-v-24bb48b5]{display:inline-block;font-size:%?40?%;height:%?40?%;line-height:%?40?%}.price[data-v-24bb48b5]{display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-box-orient:horizontal;-webkit-box-direction:normal;-webkit-flex-direction:row;-ms-flex-direction:row;flex-direction:row;-webkit-box-pack:justify;-webkit-justify-content:space-between;-ms-flex-pack:justify;justify-content:space-between;line-height:%?60?%;padding:0 %?16?%;border-top:%?2?% solid #efefef}.guigeTopCT2[data-v-24bb48b5]{color:#969696}.guigeTopClose[data-v-24bb48b5]{position:absolute;top:%?22?%;right:%?22?%;width:%?36?%;height:%?36?%}.guige .guige_con .gg uni-view[data-v-24bb48b5]{width:50%;text-align:center;height:%?74?%;line-height:%?74?%;color:#fff}.guige .guige_con .models_style[data-v-24bb48b5]{width:%?690?%;padding:%?20?% 0}.guige .guige_con .models_style .m_tit[data-v-24bb48b5]{font-size:%?26?%;color:#000}.m_tit[data-v-24bb48b5]{margin-bottom:%?10?%}.guige .guige_con .models_style .model_list uni-view[data-v-24bb48b5]{padding:%?8?% %?20?%;border-radius:%?10?%;margin-right:%?20?%;display:inline-block;min-width:%?60?%;text-align:center;border:%?2?% solid #e5e5e5;color:#232323;font-size:%?24?%}.view_maxH[data-v-24bb48b5]{max-height:%?600?%;overflow-y:auto}.view_maxH[data-v-24bb48b5]::-webkit-scrollbar{display:none}.pageno_address[data-v-24bb48b5]{display:block;margin:%?200?% auto %?60?%;width:%?280?%;height:%?140?%}body.?%PAGE?%[data-v-24bb48b5]{background:#f2f2f2}", ""]) },
        "1e53": function(i, t, e) {
            "use strict";
            e.r(t);
            var a = e("b8ce"),
        ...
        8617: function(i, t, e) {
            ...
            var n = e("2877"),
                r = Object(n["a"])(s["default"], a["a"], a["b"], !1, null, "2032cb92", null);
            t["default"] = r.exports
        },
        "89f2": function(i, t, e) {
            "use strict";
        ...
        d39b: function(i, t, e) {
            ...
            s("59166c6c", a, !0, { sourceMap: !1, shadowMode: !1 })
        },
        d6fe: function(i, t, e) {
            "use strict";
            e.r(t);
            ...
            for (var o in s) "default" !== o && function(i) { e.d(t, i, function() { return s[i] }) }(o);
            var n = e("2877"),
                r = Object(n["a"])(s["default"], a["a"], a["b"], !1, null, "5c8679c6", null);
            t["default"] = r.exports
        },
        d9b8: function(i, t, e) {
            "use strict";
            ...
            e("9f77");
            var n = e("2877"),
                r = Object(n["a"])(s["default"], a["a"], a["b"], !1, null, "24bb48b5", null);
            t["default"] = r.exports
        },
        de6a: function(i, t, e) {
            "use strict";
